        ...
        <div class='card-body'>
          <div class='table-responsive'>
            <table id='example' class='display' style='width:100%'>
                        ";
                        $sql = "SELECT * FROM signup where payment_status='paid' ORDER BY id DESC LIMIT 10 ";
                $query = mysqli_query($con,$sql);
                 if($query){
                     ...
                     $output = '<b>You do not have any Members</b>';
                 }
                 echo $output.'</tbody>';
                 }
                 echo"
               ...
               <div class='card-body'>
                ...
                $query = mysqli_query($con,$sql);
                 if($query){
                     ...
                     $output = '<b>You do not have any Members Owing</b>';
                 }
                 echo $output.'</tbody>';
                 }
                 echo"
